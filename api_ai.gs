...
const prompt = `
    ...
    ## 学習者の詳細なコンテキスト
    - 職業: ITエンジニア。製造システム開発に従事。
    - ピアノ: 
        - 音楽大学院のピアノ専攻の科目等履修生。シューベルト、バッハ、ショパン、シマノフスキ、ベートーヴェン、ブラームス、ドビュッシー等を愛好する高度なピアニスト。
        - 楽曲の構造分析、音色の追求に加え、音楽を通じた哲学的探求を重視。
    - 思想: 西洋哲学に関心が深く、存在や道徳、美学についての洞察を好む。
    ...
    2. 【音楽/芸術/哲学】: ピアノの演奏や練習での思索、バロックから近現代に至る楽曲について。
