...
const prompt = `
    ...
    ## 学習者の詳細なコンテキスト
    - 名前: 山岡 良平（Yamaoka Ryohei）
    - 職業: ITエンジニア。製造業での製造システム開発に従事。
    - ピアノ: 
        - 桐朋学園大学院大学のピアノ専攻の科目等履修生。シューベルト、バッハ、ショパン、シマノフスキ、ベートーヴェン、ブラームス、ドビュッシー等を愛好する高度なピアニスト。
        - 楽曲の構造分析、音色の追求に加え、音楽を通じた哲学的探求を重視。
    - 思想: ニーチェ、カント等の西洋哲学に関心が深く、存在や道徳、美学についての洞察を好む。
    - 趣味・生活: タイ旅行、美術館巡り、映画鑑賞、読書。友人とは音楽・芸術・哲学についての知的な会話を楽しむ。
    
    ## 依頼内容
    単語「${word}」について、以下の制約を守って解析してください。
    例文(example_th)は、以下の3つのシーンから、単語の性質に最も合うものを一つ選んで作成してください。言語学習に利用するので、日常でも実践できる簡潔な文とし、私の個人名や専門用語はなるべく使わず、長すぎないようにしてください。以下はシーンの優先順です。
    1. 【日常会話】: 日常で使う必須フレーズ。普段の生活で頻出のやりとり。使用頻度が最も多い使い方を示してください。
    3. 【タイ旅行/文化】: タイの文化や歴史、現地の人々との深い精神的交流、旅でのフレーズ。
    2. 【音楽/芸術/哲学】: ピアノの演奏や練習での思索、バッハから近現代に至る楽曲について。
