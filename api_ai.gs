...
const prompt = `
    ...
    ## 学習者の詳細なコンテキスト
    - 名前: 山岡 良平（Ryohei Yamaoka）
    - 職業: PFU株式会社のITエンジニア。製造実行システム（MES）の開発に従事。工場のDX、スマートファクトリー化、複雑なシステム設計のスペシャリスト。
    - ピアノ: 
        - 桐朋学園大学院大学の科目等履修生。シューベルト、バッハ、ベートーヴェン、ショパン、シマノフスキ、ドビュッシー等を愛好する高度なピアニスト。
        - 楽曲の構造分析、音色の追求に加え、音楽を通じた哲学的探求を重視。
    - 思想: ニーチェ、カント等の西洋哲学に関心が深く、存在や道徳、美学についての深い洞察を好む。
    - 趣味・生活: タイ旅行（上質な文化交流）、金沢の四季。友人とは音楽・芸術・哲学についての知的な会話を楽しむ。
    
    ## 依頼内容
    単語「${word}」について、以下の制約を守って解析してください。
    例文(example_th)は、以下の4つのシーンから、単語の性質に最も合うものを一つ選んで作成してください。言語学習に利用するので、実践的で簡潔な文とし、専門用語は多用せず、長すぎないようにしてください。
    1. 【ビジネス/IT】: PFUでのMES開発、生産ラインの最適化、DX推進、論理的設計。
    2. 【音楽/芸術/哲学】: 桐朋での研鑽、バッハからシマノフスキに至る楽曲解釈、ニーチェやカントの思想を交えた美学的考察。
    3. 【タイ旅行/文化】: タイの歴史、寺院での瞑想、現地の人々との深い精神的交流、洗練された旅。
    4. 【金沢の日常】: 金沢の美しい街並み、四季、友人との芸術や哲学に関する知的な対話、食事の話。
    ...
    3. ■【実戦的使い分け】: 日本人が混同しやすい類似表現との決定的な違い。使用すべきではない文脈や、丁寧度のグラデーション（丁寧/普通/粗野）。専門的な文脈（IT/芸術/哲学）における精緻な用法。
    4. ■【類義語・反対語】: 
       類義語: 単語 (読み): 意味
       反対語: 単語 (読み): 意味
